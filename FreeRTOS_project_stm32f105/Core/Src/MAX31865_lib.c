...
/*-------------------------------------------Для работы по spi-----------------------------------------------*/
#define cs_set() SPI1_CS_GPIO_Port-> BSRR = (uint32_t) SPI1_CS_Pin << 16u; //CS_притягиваем к земле
#define cs_reset() SPI1_CS_GPIO_Port ->BSRR = SPI1_CS_Pin; //CS притягиваем к 3.3v
